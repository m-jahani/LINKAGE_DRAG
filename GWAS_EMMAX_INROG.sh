...
for PHENO in /DATA/home/mjahani/LINKADE_DRAG/new_method/GWAS/phenotype/*; do
    ...
    /bin/Rscript ${PATH}/manhattan_beta.R ${OUT_DIR}/SAM_introgression_donor_ANNUUS_maf0.03_${PHENO##*/}.ps ${OUT_DIR}/SAM_introgression_donor_2nd_GERMPLASM_maf0.03_${PHENO##*/}.ps $MAP $OUT_DIR
done
